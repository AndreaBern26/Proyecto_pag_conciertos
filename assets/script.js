function getData() {
  let conciertos_json = JSON.parse(conciertos);
  return conciertos_json;
}
...
function conciertos_toHTML(concierto) {
...
document.querySelector('conciertos').innerHTML = conciertos_toHTML[0];
